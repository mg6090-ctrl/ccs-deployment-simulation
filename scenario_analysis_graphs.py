...
def w2_final_vol_distribution(w2_node_data):
    ...
    ax.hist(final_vols, bins=20, range=(0,100), color="#2c6fbb", edgecolor="white")
...
def w11_final_vol_distribution(w11_node_data):
    ...
    fig, ax = plt.subplots(figsize=(8, 5))
    ax.hist(final_vols, bins=20, range=(0, 100), color="#bb782c", edgecolor="white")
    ax.set_xlabel("final delivered volume")
    ax.set_ylabel("number of reps")
...
def w12_final_vol_distribution(w12_node_data):
    ...
    fig, ax = plt.subplots(figsize=(8, 5))
    ax.hist(final_vols, bins=20, range=(0, 100), color="#3abb2c", edgecolor="white")
    ax.set_xlabel("final delivered volume")
    ax.set_ylabel("number of reps")
